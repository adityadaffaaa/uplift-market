...
import ModalPengaturanVendor from "../../../../(vendor-pages)/dashboard/(index)/pengaturan-akun/components/ModalPengaturanVendor";
  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-white lg:w-[1170px] px-6 rounded-xl lg:p-6 gap-y-6 items-start">
        <p className="hidden lg:block text-heading2">
          Pengaturan Akun
        </p>
