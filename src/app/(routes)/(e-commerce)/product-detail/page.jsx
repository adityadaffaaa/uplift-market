        ...
        <div className="w-full px-5 flex flex-col gap-9 mt-16 max-w-md mx-auto md:max-w-2xl">
          <article className="text-textBlack flex flex-col items-center md:mt-20">
            <h1 className="text-heading4 lg:text-heading3">
              Jasa Foto Produk Berkualitas, Professional, dan Cepat 15 Foto
            </h1>
          </article>
          <div className="flex justify-between lg:justify-start">
            <div className="flex items-center">
              <Image
                ...
                height={24}
              />
              <p className="text-paragraph9 ml-[6px]">Metrofa Photography</p>
            </div>
            ...
            <div className="flex items-center">
              ...
              />
              <p className="text-paragraph9 ml-[2px]">4.7</p>
              <p className="text-paragraph9 text-grey2"> (233 reviews)</p>
            </div>
          </div>
          <div className="carousel carousel-center max-w-[335px] max-h-[168px] md:max-w-full space-x-1 bg-white lg:w-full">
            <div className="carousel-item">
              <img src="/assets/images/produk1.png" className="rounded-box" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/produk2.png" className="rounded-box" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/produk3.png" className="rounded-box" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/produk4.png" className="rounded-box" />
            </div>
            <div className="carousel-item">
              <img src="/assets/images/produk5.png" className="rounded-box" />
            </div>
          </div>
          <p className="text-paragraph3 lg:text-heading3">Detail</p>
          <p className="text-paragraph10 mb-9 lg:text-paragraph5">
            Kami menyediakan layanan video editing profesional dan motion
            graphics yang memadukan kreativitas tinggi dengan kecepatan
            pengerjaan yang luar biasa dan hasil berkualitas. Dengan tim ahli
            kami, kami mampu mengubah ide Anda menjadi video yang menakjubkan
            dan menarik. Baik Anda seorang content creator, perusahaan, atau
            individu yang membutuhkan video berkualitas tinggi, kami siap
            membantu Anda mencapai visi Anda.<br></br>
            <br></br>
            Video jadi durasi maksimal 1 menit Revisi minor maksimal 3
            Pengiriman bahan video melalui e-mail atau Google Drive
          </p>
          <div className="flex justify-between">
            <p className="text-paragraph3 lg:text-heading3">Ulasan</p>
          ...
          <div className="flex-col pt-4">
            <div className="flex items-center">
              ...
              <div className="flex-col">
                <p className="text-paragraph9 ml-[6px]">Alexander Nirwan</p>
            ...
            <p className="text-paragraph8 pt-4 lg:text-paragraph5">
              Direkomendasikan vendor ini sama temen karena katanya hasilnya
              bagus dan ternyata beneran sebagus ini. Pelayanannya sangat ramah
              mulai dari diskusi sampai akhir. Rumah saya jadi keliatan bagus
              banget.! Happy! Terima kasih dan sukses terus Pak!
            </p>
            <p className="text-paragraph8Res pt-4 pb-4">21 September 2022</p>
          </div>
          <div className="flex-col pt-4">
            <div className="flex items-center">
              <Image
          ...
          <div className="border border-[#D2D5DA] rounded-xl ">
            <div className="p-6">
              ...
              <p className="text-paragraphBold">Metafora Photography</p>
              <p className="text-paragraph10 pt-[6px]">
                Metrofa adalah vendor studio video profesional yang menyediakan
                layanan edit video berkualitas tinggi
              </p>
              <div className="flex flex-col lg:flex-row pt-6 space-y-3 lg:space-y-0 lg:justify-between">
                ...
                <div className="flex lg:flex-col justify-between lg:justify-center items-center">
                  <p className="text-paragraph10">Project Diselesaikan</p>
          ...
          <div className="flex items-center justify-between">
            <p className="text-heading4Res">Produk Lain dari Toko Ini</p>
            <p className="text-paragraph8Res text-primary">Lihat Semua</p>
          </div>
          <div className="">
